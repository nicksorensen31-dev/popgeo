...
const ALL_QUESTIONS = [
  ...
  { id:3,  type:"filmed", emoji:"🎬", clue:"The climactic cave of the Holy Grail in the third Indiana Jones film was filmed inside the ancient rose-red city carved into cliff faces in this Middle Eastern country", answer:"Petra, Jordan", blurb:"The Treasury at Petra served as the entrance to the Grail temple in The Last Crusade. The ancient Nabataean city was largely unknown to Western tourists before the film put it on the map globally.", lat:30.3285, lng:35.4444 },
  ...
  { id:14, type:"filmed", emoji:"🎬", clue:"This Central European capital has doubled as Cold War Berlin, Moscow, Paris, and Vienna in so many spy films that locals call it the Hollywood of Europe", answer:"Budapest, Hungary", blurb:"Budapest's grand boulevards and Soviet-era architecture have appeared in Spy, Mission Impossible, Atomic Blonde, and dozens of others. Its tax incentives and versatile look make it Hollywood's favorite European stand-in.", lat:47.4979, lng:19.0402 },
  ...
  { id:16, type:"filmed", emoji:"🎬", clue:"The towering sandstone buttes that John Ford used in over a dozen westerns became so iconic that they defined how the world imagined the American frontier for generations", answer:"Monument Valley, Arizona", blurb:"Monument Valley on the Navajo Nation appeared in Stagecoach, The Searchers, and Forrest Gump among dozens of others. Ford discovered it in 1938 and returned so often the valley bears his name on a scenic overlook.", lat:36.9830, lng:-110.1098 },
  { id:17, type:"filmed", emoji:"🎬", clue:"This Scottish city's George Square was evacuated and dressed as Philadelphia for a zombie apocalypse sequence, with hundreds of extras and military vehicles taking over the city center", answer:"Glasgow, Scotland", blurb:"World War Z filmed its Philadelphia outbreak scene entirely in Glasgow, using the grand Victorian architecture as a stand-in. The production shut down George Square for weeks, delighting locals and tourists alike.", lat:55.8609, lng:-4.2514 },
  ...
  { id:32, type:"filmed", emoji:"🎬", clue:"Don Draper's Madison Avenue ad agency in Mad Men was actually recreated on a soundstage in this California neighborhood, where every period detail was vetted by a full-time historian", answer:"Hollywood, California", blurb:"Mad Men filmed at Production Group International in Hollywood. The show's meticulous recreation of 1960s Manhattan was so accurate that creator Matthew Weiner required every visible prop to be period-verified.", lat:34.0928, lng:-118.3287 },
  ...
  { id:43, type:"actor", emoji:"⭐", clue:"The greatest boxer of the 20th century was born and raised in this river city, where a bridge, a museum, and an international airport now bear his name", answer:"Louisville, Kentucky", blurb:"Muhammad Ali was born Cassius Clay in Louisville in 1942. After winning Olympic gold in Rome in 1960, he returned home and was reportedly so disgusted by racist treatment at a restaurant that he threw his medal in the Ohio River.", lat:38.2527, lng:-85.7585 },
  ...
  { id:55, type:"actor", emoji:"⭐", clue:"This director was born in this Ohio city, spent his childhood moving across Arizona and California, and was rejected by film school twice before Universal handed him a directing contract at 21", answer:"Cincinnati, Ohio", blurb:"Steven Spielberg was born in Cincinnati but grew up across several states. He was rejected by USC film school twice and eventually dropped out of Cal State Long Beach when Universal offered him a TV directing deal.", lat:39.1031, lng:-84.5120 },
  ...
  // ── FILM/TV GEO FACTS ────────────────────────────────────────────────────────
  { id:61, type:"filmed", emoji:"🌍", clue:"This small New Zealand town became so synonymous with a fictional hobbit village that it permanently rebranded itself and now draws over 500,000 film tourists per year", answer:"Matamata, New Zealand", blurb:"Matamata's Alexander Farm became Hobbiton for the Lord of the Rings trilogy. Peter Jackson made it a permanent set after filming, and it now operates year-round with guided tours and an inn.", lat:-37.8724, lng:175.6854 },
  { id:62, type:"filmed", emoji:"🌍", clue:"This legendary studio complex on the outskirts of the Italian capital has hosted Ben-Hur, Cleopatra, La Dolce Vita, and Gangs of New York — Fellini called it his second home and made nearly every film of his career there", answer:"Cinecittà Studios, Italy", blurb:"Cinecittà studios were built by Mussolini in 1937 and became the epicenter of Italian and international filmmaking. Federico Fellini made almost every film of his career there and called it his second home.", lat:41.8457, lng:12.5540 },
  { id:63, type:"filmed", emoji:"🌍", clue:"This Tunisian desert hotel, built in a traditional underground pit-dwelling style, became Luke Skywalker's childhood home and still operates as a guesthouse for Star Wars fans", answer:"Matmata, Tunisia", blurb:"The Sidi Driss Hotel in Matmata served as the Lars Homestead on Tatooine. George Lucas discovered it during a location scout in 1976. It was nearly demolished before Star Wars fan campaigns saved it.", lat:33.5440, lng:9.9712 },
  { id:64, type:"filmed", emoji:"🌍", clue:"This Southern city has become the third most filmed location in the world, hosting The Walking Dead, Stranger Things, Avengers, and hundreds of other productions due to generous state tax incentives", answer:"Atlanta, Georgia", blurb:"Georgia's 30% film tax credit transformed Atlanta into a production hub. By 2019 it hosted more film and TV productions than any city outside Los Angeles and New York, earning the nickname 'Y'allywood.'", lat:33.7490, lng:-84.3880 },
  { id:65, type:"filmed", emoji:"🌍", clue:"This ancient Irish island monastery, accessible only by boat in rough Atlantic waters, served as Luke Skywalker's remote hideout and required the entire film crew to be helicopter-lifted to the summit", answer:"Skellig Michael, Ireland", blurb:"Skellig Michael, a UNESCO World Heritage Site off the Kerry coast, appears in The Force Awakens and The Last Jedi. The 6th-century monastic beehive huts required minimal set dressing — they already looked like another galaxy.", lat:51.7731, lng:-10.5394 },
  { id:66, type:"filmed", emoji:"🌍", clue:"This tiny Welsh village became the world's most filmed location per capita after a beloved romantic drama series used it as its primary set for eleven seasons", answer:"Portmeirion, Wales", blurb:"The Italianate village of Portmeirion in North Wales served as 'The Village' in the cult 1960s series The Prisoner. Its unique architecture made it instantly recognizable and drove decades of fan tourism.", lat:52.9135, lng:-4.0895 },
  { id:67, type:"filmed", emoji:"🌍", clue:"The park bench where a man with a box of chocolates waited for a bus and narrated his life story to strangers was filmed in a historic square in this Georgia coastal city", answer:"Savannah, Georgia", blurb:"The Forrest Gump bus stop bench was filmed in Chippewa Square in Savannah. The bench itself is now in the Savannah History Museum — the city installed a replica at the original filming location.", lat:32.0835, lng:-81.0998 },
  { id:68, type:"filmed", emoji:"🌍", clue:"This perfectly preserved medieval Belgian city was the unlikely setting for a dark comedy about two hitmen ordered to hide out there after a botched job, which the director called a fairy tale for grown-ups", answer:"Bruges, Belgium", blurb:"In Bruges filmed almost entirely on location, using the real canal-lined streets, churches, and market square. Tourism to Bruges increased measurably after the film, though locals noted the film's characters spend most of it complaining about the place.", lat:51.2093, lng:3.2247 },
  { id:69, type:"filmed", emoji:"🌍", clue:"This Central European capital's Baroque architecture and cobbled old town have made it Hollywood's go-to stand-in for Cold War cities, featuring in Amadeus, Mission Impossible, and Anthropoid", answer:"Prague, Czech Republic", blurb:"Prague's well-preserved historic center survived WWII bombing largely intact, making it uniquely versatile for period productions. Its lower costs and generous incentives have attracted major productions since the 1990s.", lat:50.0755, lng:14.4378 },
  { id:70, type:"filmed", emoji:"🌍", clue:"This tiny East African nation on the Horn of Africa served as the filming location for a tense hostage drama about Somali pirates, chosen for its proximity to the actual shipping lanes where the real events occurred", answer:"Djibouti", blurb:"Captain Phillips filmed its Somali sequences in Djibouti, using the real Gulf of Aden shipping lanes nearby. The production hired actual residents of the region as extras and supporting cast.", lat:11.8251, lng:42.5903 },
];
