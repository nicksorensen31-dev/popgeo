...
const ALL_QUESTIONS = [
  ...
  { id:62, type:"filmed", emoji:"🌍", clue:"This Croatian coastal city imposed daily visitor caps after a single HBO fantasy series caused tourist numbers to triple and locals struggled to walk their own streets", answer:"Dubrovnik, Croatia", blurb:"Dubrovnik limited visitors to 4,000 per day after Game of Thrones fans overwhelmed the old city. The mayor cited the show directly as the cause, calling it a blessing and a curse simultaneously.", lat:42.6507, lng:18.0944 },
  ...
  { id:64, type:"set", emoji:"🌍", clue:"A fictional New Mexico high school chemistry teacher's transformation into a drug lord caused tourism to this real city to jump by 10%, with fans visiting a car wash and a laundromat", answer:"Albuquerque, New Mexico", blurb:"Breaking Bad tourism became a genuine economic force in Albuquerque. The city runs official filming location tours, and local businesses that appeared in the show market themselves heavily to fans.", lat:35.0844, lng:-106.6504 },
  { id:65, type:"filmed", emoji:"🌍", clue:"More films have used this Spanish desert as a stand-in for the American West than any other location outside the United States — it still operates as a working western theme park", answer:"Tabernas Desert, Spain", blurb:"The Tabernas Desert in Almería hosted Clint Eastwood's Dollar Trilogy, Indiana Jones, and hundreds of other productions. Three western-themed parks built on the original sets still welcome visitors.", lat:37.0532, lng:-2.3642 },
  ...
  { id:67, type:"filmed", emoji:"🌍", clue:"New Zealand's national airline rebranded its entire fleet with Middle-earth livery after this film trilogy made the country the most recognized film tourism destination in the world", answer:"New Zealand", blurb:"Air New Zealand became 'The Airline of Middle-earth' and painted multiple aircraft with Lord of the Rings and Hobbit imagery. The tourism boost from Peter Jackson's films is estimated at billions of dollars.", lat:-40.9006, lng:174.8860 },
  { id:68, type:"set", emoji:"🌍", clue:"A bronze statue of a fictional boxer stands outside a real art museum in this city after the prop was donated following the third film in the franchise — and is now one of the city's most photographed landmarks", answer:"Philadelphia, Pennsylvania", blurb:"Sylvester Stallone donated the Rocky statue to Philadelphia after Rocky III. The city briefly moved it before returning it to its current spot near the museum steps. Over a million people visit it annually.", lat:39.9526, lng:-75.1652 },
  { id:69, type:"filmed", emoji:"🌍", clue:"This Jordanian valley, called the Valley of the Moon, has appeared in so many science fiction and epic films that it has been nicknamed Hollywood of the desert", answer:"Wadi Rum, Jordan", blurb:"Wadi Rum hosted Lawrence of Arabia, The Martian, Dune, Rogue One, and Aladdin among dozens of others. Its Mars-like landscape is so convincing that NASA uses it to test rover equipment.", lat:29.5731, lng:35.4125 },
  { id:70, type:"filmed", emoji:"🌍", clue:"This Ohio reformatory was scheduled for demolition until a 1994 prison escape film made it so beloved that preservation groups raised funds to save it and turn it into a tourist attraction", answer:"Mansfield, Ohio", blurb:"The Ohio State Reformatory in Mansfield was saved entirely by The Shawshank Redemption's cult following. It now hosts film tours, paranormal investigations, and a dedicated fan event called Shawshank Hustle.", lat:40.7662, lng:-82.5190 },
];
